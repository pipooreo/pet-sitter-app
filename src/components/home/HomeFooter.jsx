      ...
      <div className="bg-yellow-100 flex flex-col items-center justify-center h-[469px] xl:w-[1280px] md:rounded-2xl w-full relative overflow-hidden">
        <div className="flex flex-col gap-10 w-[344px] md:w-[457px] items-center z-10">
          ...
          <div className="flex flex-col gap-4 md:flex-row">
            <button className="text-orange-500 text-[16px] font-bold leading-6 text-center bg-orange-100 rounded-[99px] p-[12px_24px] hover:text-orange-400 active:text-orange-600">
              Become A Pet Sitter
            </button>
            <button className="text-white text-[16px] font-bold leading-6 text-center bg-orange-500 rounded-[99px] p-[12px_24px] hover:bg-orange-400 active:bg-orange-600">
              Find A Pet Sitter
            </button>
          </div>
        </div>
