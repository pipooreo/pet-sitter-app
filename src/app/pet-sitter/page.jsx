            ...
            <div>
              ...
              <li
                ...
                className={`cursor-pointer text-gray-500 hover:text-orange-500 p-[16px_24px_16px_24px] flex justify-start items-center gap-[16px] ${
                  selectedMenu === "profile" && "bg-orange-100 text-orange-500"
                }`}
              >
              ...
              <li
                ...
                className={`cursor-pointer text-gray-500 hover:text-orange-500 p-[16px_24px_16px_24px] flex justify-start items-center gap-[16px] ${
                  selectedMenu === "booking" && "bg-orange-100 text-orange-500"
                }`}
              >
              ...
              <li
                ...
                className={`cursor-pointer text-gray-500 hover:text-orange-500 p-[16px_24px_16px_24px] flex justify-start items-center gap-[16px] ${
                  selectedMenu === "calendar" && "bg-orange-100 text-orange-500"
                }`}
              >
